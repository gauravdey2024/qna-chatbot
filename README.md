An end-to-end Retrieval-Augmented Generation (RAG) system built with LangChain, Google Gemini,
and ChromaDB to perform question answering over domain-specific PDF documentation with conversational
memory, LangSmith tracing, and automated Ragas evaluation.  
